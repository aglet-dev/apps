      ...
      <DataScope alias="cl" collection="current" query={{where:{source:"claude"}}} latest>
        <VStack gap={3}>
          <HStack className="items-center">
            ...
            <Spacer/>
            <Text className="text-[10px] tabular-nums text-zinc-300">{{op:"state", path:"/data/cl/cost_text"}}</Text>
          </HStack>
          <VStack gap={1}>
            <HStack className="items-center">
            ...
            <Progress
              ...
              size="sm"
            />
            <Text className="text-[10px] text-zinc-300 leading-tight">{t.resets} {{op:"state", path:"/data/cl/session_reset_text"}}</Text>
          </VStack>
          <VStack gap={1}>
            <HStack className="items-center">
            ...
            <Progress
              ...
              size="sm"
            />
            <Text className="text-[10px] text-zinc-300 leading-tight">{t.resets} {{op:"state", path:"/data/cl/weekly_reset_text"}}</Text>
          </VStack>
      ...
      <DataScope alias="cx" collection="current" query={{where:{source:"codex"}}} latest>
        <VStack gap={3}>
          <HStack className="items-center gap-1.5">
            ...
            <Text className="text-[9px] uppercase text-zinc-300">{{op:"state", path:"/data/cx/source_text"}}</Text>
            <Spacer/>
            <Text className="text-[10px] text-zinc-300">{{op:"state", path:"/data/cx/plan_text"}}</Text>
            <Text className="text-[10px] tabular-nums text-zinc-300">{{op:"state", path:"/data/cx/credits_text"}}</Text>
          </HStack>
          <VStack gap={1}>
            <HStack className="items-center">
            ...
            <Progress
              ...
              size="sm"
            />
            <Text className="text-[10px] text-zinc-300 leading-tight">{t.resets} {{op:"state", path:"/data/cx/session_reset_text"}}</Text>
          </VStack>
          <VStack gap={1}>
            <HStack className="items-center">
              <Text className="text-[10px] uppercase tracking-wider text-zinc-300">{t.week}</Text>
            ...
            <Progress
              ...
              size="sm"
            />
            <Text className="text-[10px] text-zinc-300 leading-tight">{t.resets} {{op:"state", path:"/data/cx/weekly_reset_text"}}</Text>
          </VStack>
